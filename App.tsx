...
import { CONTACTOUT_REVIEW } from './constants';

const App: React.FC = () => {
  const content = CONTACTOUT_REVIEW;
  ...
  return (
    <Layout>
      ...
      {/* What is ContactOut + Screenshot 1 */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="mt-4 text-center text-sm text-gray-400 italic">Exploring the {content.competitorName} sidebar on LinkedIn Recruiter.</p>
            </div>
          </div>
            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-xl p-3 overflow-hidden">
                <img 
                  ...
                  alt={`${content.competitorName} Profile View`} 
                  className="w-full h-auto rounded-lg"
                />
              </div>
              <div className="mt-8 p-6 bg-blue-50 rounded-xl border border-blue-100">
                <p className="text-[#3477E4] font-medium italic">
                  "The triple-verification process for emails consistently delivers high-quality addresses. It's the primary reason users stick with {content.competitorName}."
                </p>
              </div>
            </div>
            <div className="w-full lg:w-1/2">
              ...
              <div className="space-y-6 mb-12">
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 group hover:border-[#3477E4] transition-colors">
                  <div className="text-gray-500 text-xs font-bold uppercase mb-1">Email Deliverability</div>
                  <div className="text-2xl font-bold text-[#121212]">{content.accuracyData.email}</div>
                </div>
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 group hover:border-[#3477E4] transition-colors">
                  <div className="text-gray-500 text-xs font-bold uppercase mb-1">Database Reach</div>
                  <div className="text-2xl font-bold text-[#121212]">{content.accuracyData.decay}</div>
                </div>
              </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">The difference between a search-retrieval tool and a high-hygiene data enrichment engine.</p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                <tr className="border-b border-gray-50">
                  ...
                  <td className="py-6 px-8 text-gray-500">Individual contact retrieval on LinkedIn</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Bulk enrichment and hygiene</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Data Cleaning</td>
                  <td className="py-6 px-8 text-gray-500">Minimal (Triple-verification only)</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">AI-Powered (Clean names, remove emojis/LLC)</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Monitoring</td>
                  <td className="py-6 px-8 text-gray-500">None (Static profile capture)</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Automated weekly job-change alerts</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="py-6 px-8 font-semibold text-gray-700">Best Case</td>
                  <td className="py-6 px-8 text-gray-500">Finding personal emails for recruits</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Clean, high-deliverability CRM syncs</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-[#121212] rounded-[3rem] py-24 px-8 relative overflow-hidden shadow-2xl border border-gray-800">
            ...
            <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto relative z-10">
              Don't settle for static database exports that decay by 30% every year. Experience the power of multi-provider verified, high-volume enrichment that cleans and monitors your leads automatically.
            </p>
